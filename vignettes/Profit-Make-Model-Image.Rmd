...
A faster image can be genreate if the remax flag is turned on. With remax=10 it only takes ~2.5 seconds to make the model image. This might be accurate enough for many simualtion purposes, and is a factor 2 faster.
